...
function deObjetoAmatriz(objeto){
  ...
  //Escribe tu código aquí
    var arreglo = [];
    for ( var propiedad in objeto) {arreglo.push([propiedad, objeto[propiedad]])
...
if(!objeto.hasOwnProperty(string[i])) {objeto[string[i]] = 0;}
objeto[string[i]] += 1;    
  }
  return objeto;
}
...
var numeroreves = numerostr.split("").reverse().join("");
if (numerostr === numeroreves) {return "Es capicua";}
